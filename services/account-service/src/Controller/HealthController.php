...
/**
 * HealthController provides a liveness probe endpoint for the Account Service.
 *
...
{
    /**
     * Returns the health status of the Account Service.
     *
     ...
     *
     * @Route("/account/health", name="health_check", methods={"GET"})
     *
