...
/**
 * HealthController provides a liveness probe endpoint for the Transaction Service.
 *
...
{
    /**
     * Returns the health status of the Transaction Service.
     *
     ...
     *
     * @Route("/transaction/health", name="health_check", methods={"GET"})
     *
